...
import { processRecordResend } from "../../../../lib/server/process-record-resend.js";
...
export async function POST(request) {
  try {
    ...
    const result = await processBatch(records, processRecordResend);
    ...
    if (!(error instanceof ValidationError)) {
      log("Free coffee batch API request failed", {
