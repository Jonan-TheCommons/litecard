...
const RESEND_TEMPLATE_ID = 45294703;

export const sendResendEmailWithRetry = async ({ email, appleLink, googleLink }, context = {}) => {
  return sendLitecardEmailWithRetry(
    {
      email,
      templateId: RESEND_TEMPLATE_ID,
      templateModel: createLoyaltyTemplateModel({ appleLink, googleLink }),
    },
    context,
  );
};
